...
'=========================================================='
 Write-Host  30. FIREWALL PRESENT IN DOMAIN
'=========================================================='
$strFilter = "computer"
...
'=========================================================='
 Write-Host  31. FIREWALL STATUS - COMPLIANCE/NON-COMPLIANCE
'=========================================================='
$FirewallStatus = 0
...
'=========================================================='
Compress-Archive output.txt -DestinationPath "$CurrentDir\Windows_HBA_Scirpt_2012_Output.zip"
